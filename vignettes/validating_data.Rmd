...
computer, as it will require storing the username and password you access DATIM as a file on your disk.
...
your username and password, and stored in a local cache. Once the objects are cached, the package can be used off-line, until the cache is invalidated. 
