...
---
## Installation of the datimvalidation package

There are several dependencies which are required to use the `datimvalidation` package. 

1) A recent copy of R.
2) A recent copy of the Rtools package.
