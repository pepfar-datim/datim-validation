...
getValidationRules<-function(remove_decoration = FALSE, creds) {
  
url<-paste0(creds$baseurl,"api/",api_version(),"/validationRules.json?fields=id,name,description,leftSide[expression,missingValueStrategy],rightSide[expression,missingValueStrategy],operator,periodType&paging=false")
