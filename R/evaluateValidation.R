...
evaluateValidation<-function(combis,values,vr,return_violations_only=TRUE) {
  ...
  if (nrow(matches) > 0 ) {
   ...
   matches_ex$leftSide.expression<-matches_ex$leftSide.ops != matches_ex$leftSide.count
   matches_ex$rightSide.expression<-matches_ex$rightSide.ops != matches_ex$rightSide.count
   ...
   matches_comp$leftSide.expression<-matches_comp$leftSide.ops != matches_comp$leftSide.count
   matches_comp$rightSide.expression<-matches_comp$rightSide.ops != matches_comp$rightSide.count
  ...
  matches<-rbind(matches,matches_comp,matches_ex)
